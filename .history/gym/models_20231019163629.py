...
class Trainer(BaseModel):
    trainer = models.ForeignKey(MyUser, on_delete=models.CASCADE, null=True)
...
class Dietician(BaseModel):
    dietician = models.ForeignKey(MyUser, on_delete=models.CASCADE, null=True)
    job = models.CharField(max_length=32, choices=type_job)
...
class MentalTrainer(BaseModel):
    mental_trainer = models.ForeignObject(MyUser, on_delete=models.CASCADE, null=True)
    job = models.CharField(max_length=32, choices=type_job)
